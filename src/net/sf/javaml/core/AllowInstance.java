 ...
 * 
 */
public class AllowInstance extends AbstractInstance implements Instance {
     ...
     */
    public AllowInstance(double[] att) {
        this(att, null);
    }
     ...
     *            the class label
     */
    public AllowInstance(double[] att, Object classValue) {
        super(classValue);
        this.attributes = att.clone();
    }

    /* Hide argumentless constructor */
    private AllowInstance() {
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final AllowInstance other = (AllowInstance) obj;
    ...
    public Instance copy() {
        AllowInstance out = new AllowInstance();
